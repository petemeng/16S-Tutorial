...
-rw-r--r-- 1 user user  20M  barcodes.fastq.gz
-rw-r--r-- 1 user user 137M  forward.fastq.gz
-rw-r--r-- 1 user user 154M  reverse.fastq.gz
```
...
```
📊 输出：
-rw-r--r-- 1 user user 310M data/emp-paired-end-sequences.qza
```
