...
**图 1：LEfSe 条形图。** 左侧是 Baquedano 富集 genus，右侧是 Yungay 富集 genus。这里最值得注意的是：Yungay 侧的 **Crossiella**、**JG30-KF-CM45**，以及 Baquedano 侧的 **Paenibacillus**、**Marmoricola**，后面还会在随机森林里继续出现。
