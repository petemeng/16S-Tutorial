...
![](../assets/16s/ch13_publication_overview-cbff5679a0.png)
...
# A tibble: 15 × 2
 ...
 8 NSTI median                                  0.219
 9 Spearman network edges                       26
10 Network modularity index                     0.598
...
3. **网络层面**：共现网络识别出 4 个模块（modularity = 0.598），`Ralstonia` 为 degree 最高的核心节点
