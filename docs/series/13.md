...
![](../assets/16s/ch13_publication_overview-94f8dc1fb4.png)
...
# A tibble: 15 × 2
 ...
 8 NSTI median                                  0.219
 9 Spearman network edges                       64
10 Network modularity index                     0.475
...
# A tibble: 10 × 11
 ...
 1 Paenibacillus                         5.96      Baquedano   3.80 TRUE      Baquedano    -1.10   FALSE        5     34           2
 2 0319-7L14                             9.94      NA          NA   NA        Yungay        1.09   FALSE        5      9           1
 3 Unclassified_Family_unclassified.16   7.88      NA          NA   NA        NA            NA     NA           3     10           1
 4 Unclassified_Family_unclassified.12   7.81      NA          NA   NA        NA            NA     NA           8     37           1
 5 Unclassified_Xanthobacteraceae        7.65      NA          NA   NA        NA            NA     NA           5    210           1
 6 Unclassified_Family_unclassified.1    7.58      NA          NA   NA        NA            NA     NA           1      0           1
 7 WD2101_soil_group                     7.41      Yungay      3.65 TRUE      Yungay        0.548  FALSE        NA     NA          1
 8 Rubrobacter                           7.31      NA          NA   NA        Yungay        1.11   FALSE        3     34           1
 9 Ammoniphilus                          5.63      NA          NA   NA        Baquedano    -0.757  FALSE        9     70           1
10 Unclassified_Family_unclassified.10   8.71      NA          NA   NA        NA            NA     NA           NA     NA          0
```

这张表的意义非常直接：

**`Paenibacillus`** 是整个系列里证据最集中的核心 biomarker 候选——LEfSe 显著、随机森林重要性靠前、且在共现网络中拥有跨模块连接（EvidenceCount = 2）。

`0319-7L14` 也很值得注意，因为它同时出现在随机森林（重要性排名第 2）和网络里（degree = 5），且在 Zi-Pi 分析中被识别为 Connector 节点。
...
3. **网络层面**：共现网络识别出 6 个模块（modularity = 0.475），`Ralstonia` 为 degree 最高的核心节点，Zi-Pi 分析检出 5 个 Connector 节点
