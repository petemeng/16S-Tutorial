...
PC1 解释了 8.52% 的变异，PC2 解释了 6.54% 的变异。解释率不像人体体位点教学数据那么夸张，但 PERMANOVA 仍然能告诉我们：这种分离在统计上是真实存在的。
...
**图 4：发表级 Bray-Curtis PCoA 图。** 95% 置信椭圆显示两条 transect 的样本中心确实偏移，但仍有部分重叠。PC1 解释了 8.52% 的变异，PC2 解释了 6.54% 的变异。
...
echo "  PC1 (8.52%): 主轴分离 Baquedano vs Yungay"
echo "  PC2 (6.54%): 反映组内与 site-level 差异"
echo ""
